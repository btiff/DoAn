...
public class FragmentDownload extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View layout = inflater.inflate(R.layout.fragment_download, container,
				false);
		listView = (ListView) layout.findViewById(R.id.list_fragment_download);
		gridView = (GridView) layout.findViewById(R.id.grid_fragment_download);
		chuyen();
		return layout;
	}
