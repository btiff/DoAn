...
public class FragmentFitWidth extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View layout = inflater.inflate(R.layout.fragment_fit_width, container,
				false);
		listView = (ListView) layout.findViewById(R.id.list_fragment_fit_width);
		gridView = (GridView) layout.findViewById(R.id.grid_fragment_fit_width);
	...
	public void chuyen() {
		list = MainActivity.db.getDataWidth(width+"");
		list_picture=list;
		if (list.size() != 0) {
			list_picture = list;
