...
public class FragmentFitHeight extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View layout = inflater.inflate(R.layout.fragment_fit_height, container,
				false);
		listView = (ListView) layout
				.findViewById(R.id.list_fragment_fit_height);
		gridView = (GridView) layout
				.findViewById(R.id.grid_fragment_fit_height);
	...
	public void chuyen() {
		list = MainActivity.db.getDataHeght(height+"");
		list_picture=list;
		if (list.size() != 0) {
			list_picture = list;
